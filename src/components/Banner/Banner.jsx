            ...
            <div className='flex flex-col-reverse lg:flex-row  items-center max-w-6xl mx-auto lg:pt-32 px-4 pb-8 lg:pb-0'>
                <div className=''>
                    ...
                    <div className='flex items-center gap-2 md:gap-4'>
                        <button className="btn bg-[#F59E0B] text-white normal-case text-base px-6 rounded-md hover:bg-[#D97706]  duration-1000 border-none">
                            Hire Me
                        </button>
                        <a href={ResumePDF}
                            ...
                            rel="noreferrer"
                        >
                            <button className="btn bg-[#FDF0DB] text-[#F59E0B] normal-case text-base px-6 rounded-md hover:bg-[#D97706] hover:text-white  duration-1000 border border-[#e2ceac] ">
                                Download Resume
