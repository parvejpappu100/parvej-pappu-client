...
const Skills = () => {
    return (
        <div className='bg-[#F9FAFB] mb-32'>
            <div className='max-w-[1120px] mx-auto py-32 px-4'>
                <SectionTitle title={"Skills"} subTitle={"My Skill"}></SectionTitle>
                <div className='mt-24'>
                    <div>
                        <div className='flex flex-col lg:flex-row justify-between items-center shadow hover:shadow-lg duration-500 bg-white py-10 rounded-md'>
                        ...
                        <div className='flex flex-col lg:flex-row gap-5 lg:gap-0 justify-between items-center shadow hover:shadow-lg duration-500 bg-white py-10 rounded-md my-10'>
                            <div className=' px-10 border-e w-full'>
